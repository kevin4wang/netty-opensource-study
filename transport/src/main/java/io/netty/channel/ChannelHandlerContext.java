 ...
 * 每一个pipeline对应一个ChannelHandlerContext，对应关系{@link AbstractChannel}AbstractChannel的空构造器
 * AttributeMap可以给ChannelHandlerContext设置自定义属性
 * ChannelInboundInvoker：触发读，注册等事件
 * ChannelOutboundInvoker：触发写事件
 */
...
//    一个ChannelHandlerContext对应一个channelhandler
     ...
     */
//    哪个NioEventLoop会执行该ChannelHandlerContext
